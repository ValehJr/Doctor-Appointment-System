...
class RegisterCustomerModel {
    func validateUserInput(user: Customer, confirmPassword: String?) -> String? {
    ...
    func registerUser(user: Customer, completion: @escaping (Bool) -> Void) {
